...
class l10n_ar_wsafip_fex_config(osv.osv_memory):
    ...
    _columns = {
        ...
        'wsfex_certificate_id': fields.many2one('crypto.certificate', 'Certificate', required=True),
        'wsfex_for_homologation': fields.boolean('Is for homologation'),
        'wsfex_point_of_sale': fields.selection(_get_pos, 'Point of Sale', required=True),
    }
    _defaults= {
